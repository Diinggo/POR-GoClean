...
<!--  -->
	<div class="row">
		<div class="col-md-8">
			<div class="well">
				<input type="submit" class="btn btn-success btn-block" name="simpanet" 
				value="Simpan dan Cetak Struk">
			</div>
		<!--  -->
					...
					<table class="table table-striped">
						...
						?>
							<tr>
								...
								<td>
									<a href="?p=etransaksi&id=<?php echo $_GET['id'] ?>&del=<?php echo $drt['kd_dtransaksi'] ?>"
					...
					<table class="table table-striped">
						<tbody>
							<tr>
								...
								value="<?php echo $dty['nm_konsumen'] ?>" readonly=""></td>
							</tr>
							<tr>
								<td>Tanggal Transaksi</td>
								<td><input type="date" name="awal" class="form-control"
								value="<?php echo $dty['tgl_transaksi']?>"></td>
							</tr>
							<tr>
								<td>Tanggal Ambil</td>
								<td><input type="date" name="akhir" class="form-control"
								value="<?php echo $dty['tgl_ambil'] ?>"></td>
							</tr>
							<tr>
								<td>Diskon</td>
								<?php
								...
								onkeyup="tambah()" value="<?php echo $a; ?>" 
